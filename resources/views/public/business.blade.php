<x-public-layout :title="$business->name" :business="$business"
    :description="__('Book your appointment at :name', ['name' => $business->name])">
    <header class="mb-6">
    ...
    <h2 class="mb-3 font-semibold">{{ __('Book your appointment') }}</h2>
    ...
    @if (! empty($reviews))
        <section class="mt-8">
            <h2 class="mb-3 font-semibold">{{ __('Reviews') }}</h2>
            <ul class="space-y-3">
