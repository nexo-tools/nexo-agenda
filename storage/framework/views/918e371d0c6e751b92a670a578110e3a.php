                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:#ffffff;border-radius:16px;overflow:hidden;">
                    <tr>
                        <td style="background:#0f766e;padding:20px 28px;">
                            <span style="color:#ffffff;font-size:18px;font-weight:bold;"><?php echo e($businessName ?? config('app.name')); ?></span>
                        </td>
                    </tr>
                    <tr>
...
<?php /**PATH /app/resources/views/emails/layout.blade.php ENDPATH**/ ?>